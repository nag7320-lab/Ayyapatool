# =============================================================================
# Aypa TaxAI - Main Terraform Configuration
# AWS Infrastructure: VPC, ECS Fargate, RDS, ElastiCache, S3, ALB
...
terraform {
  ...
  # backend "s3" {
  #   bucket         = "aypa-taxai-terraform-state"
  #   key            = "infrastructure/terraform.tfstate"
  #   region         = "ap-south-1"
  #   encrypt        = true
  #   dynamodb_table = "aypa-taxai-terraform-locks"
  # }
}
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "RATELIMIT_STORAGE_URI", value = "redis://${aws_elasticache_replication_group.main.primary_endpoint_address}:6379/1" },
...
resource "aws_elasticache_replication_group" "main" {
  ...
  description          = "Aypa TaxAI ${var.environment} Redis cluster"
    ...
    Statement = [
      {
        ...
        Effect = "Allow"
        Principal = {
          AWS = "arn:aws:iam::718504428378:root" # ap-south-1 ELB account
        }
        Action   = "s3:PutObject"
